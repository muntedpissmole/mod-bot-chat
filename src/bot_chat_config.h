#ifndef BOT_CHAT_CONFIG_H
#define BOT_CHAT_CONFIG_H
...
extern bool        g_AdultEnable;
extern uint32_t    g_AdultHour;
extern uint32_t    g_Toxicity;
extern uint32_t    g_BlowupChance;
extern uint32_t    g_BlowupSeconds;
...
// --------------------------------------------
extern bool        g_EnableChannelThreads;
extern uint32_t    g_ChannelThreadMaxLines;
extern uint32_t    g_TopicIdleSeconds;
extern uint32_t    g_ContinueTopicChance;
extern bool        g_PreferThreadRegulars;
extern std::string g_ChannelThreadHeaderTemplate;
extern std::string g_ChannelThreadLineTemplate;
extern std::string g_RandomChatterContinueTemplate;

// --------------------------------------------
// Live game knowledge lookup
// --------------------------------------------
extern bool        g_EnableGameKnowledge;
extern uint32_t    g_GameKnowledgeMaxFacts;
extern uint32_t    g_QuestionReplyChanceBonus;
extern bool        g_AlwaysReplyToPlayerQuestions;
extern std::string g_GameKnowledgePromptTemplate;
extern std::string g_GameKnowledgeNoneTemplate;

class BotChatRAGSystem;
extern BotChatRAGSystem* g_RAGSystem;                     // Global RAG system instance
...
// --------------------------------------------
class BotChatConfigWorldScript : public WorldScript
{
public:
