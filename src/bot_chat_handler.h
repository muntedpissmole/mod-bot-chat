#ifndef BOT_CHAT_HANDLER_H
#define BOT_CHAT_HANDLER_H
...
class BotChatHandler : public PlayerScript
{
public:
    BotChatHandler() : PlayerScript("BotChatHandler", {
